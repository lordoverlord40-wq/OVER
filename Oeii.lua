...
local window = library:AddWindow("ALEKING HUB | Private Farming", {
    ...
    title_bar = {Color3.fromRGB(0, 0, 0), Color3.fromRGB(0, 0, 0)},
...
infoTab:AddLabel("â”â”â”â”â”â”â”â”  âš¡ ALEKING HUB INFO  â”â”â”â”â”â”â”â”")
infoTab:AddLabel("ðŸŽ®  Script:   ALEKING HUB  |  Muscle Legends")
infoTab:AddLabel("ðŸ‘‘  Author:   ALEKING")
infoTab:AddLabel("ðŸ“Š  Version:  1.2")
infoTab:AddLabel("ðŸ“±  Discord:  discord.gg/RKCLANISBEST")
infoTab:AddLabel("ðŸ”§  Toggle:   RightShift key")
infoTab:AddLabel("â”â”â”â”â”â”â”â”  ðŸŒ LIVE PLAYER INFO  â”â”â”â”â”â”â”â”")
local pingLbl  = infoTab:AddLabel("ðŸ“¶  Ping:  calculating...")
local nameLbl  = infoTab:AddLabel("ðŸ‘¤  Name:  "..player.Name)
local dispLbl  = infoTab:AddLabel("ðŸ·ï¸  Display:  "..player.DisplayName)
local idLbl    = infoTab:AddLabel("ðŸ†”  UserID:  "..player.UserId)
local charLbl  = infoTab:AddLabel("ðŸŒ  Server Players:  "..#game.Players:GetPlayers())
infoTab:AddLabel("â”â”â”â”â”â”â”â”  ðŸ–¥ï¸ SERVER INFO  â”â”â”â”â”â”â”â”")
local jobLbl   = infoTab:AddLabel("ðŸ–¥ï¸  JobID:  "..game.JobId:sub(1,20).."...")
local placeLbl = infoTab:AddLabel("ðŸ“  PlaceID:  "..game.PlaceId)
task.spawn(function()
    while task.wait(2) do
        pcall(function()
            charLbl.Text = "ðŸŒ  Server Players:  "..#game.Players:GetPlayers()
            local s=tick()
...
local FastRebTab = window:AddTab("âš¡  Fast Rebirth")
...
local fastRebirthSwitch = FastRebTab:AddSwitch("âš¡  Fast Rebirth", function(state)
    isRunning = state
...
-- ====== CUADRO DE ESTADÃSTICAS EN PANTALLA ======
...
titleLabel.Text = "â±ï¸ Stats"
titleLabel.Parent = mainFrame

-- Contenedor de stats
local statsContainer = Instance.new("Frame")
statsContainer.Name = "StatsContainer"
statsContainer.BackgroundColor3 = Color3.fromRGB(0, 0, 0)
